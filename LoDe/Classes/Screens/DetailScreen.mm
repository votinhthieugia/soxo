...
void DetailScreen::loadTextures() {
}

void DetailScreen::unloadTextures() {
}

void DetailScreen::setState(int nextState) {
	state = nextState;
...
void DetailScreen::update(float elapsedSeconds, vector<Touch *> *touches) {
	switch (state) {
		case STATE_TRANSITION_IN:
...
void DetailScreen::updateStateReady(float elapsedSeconds, vector<Touch *> *touches) {
}

void DetailScreen::draw() {
	glPushMatrix();
...
void DetailScreen::handleEvent(int eventId, void *data) {
	switch (eventId) {
	}
}

void DetailScreen::pause() {
